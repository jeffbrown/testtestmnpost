...
@MicronautTest
class ControllerControllerTest(private val embeddedServer: EmbeddedServer) {
    ...
    fun testIndex() {
        ...
        assertEquals(HttpStatus.OK, client.toBlocking().exchange("/controller", String::class.java).status())
        client.close()
    }
}
